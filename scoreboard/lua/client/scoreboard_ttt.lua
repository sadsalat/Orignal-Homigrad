    ...
    function()
        ...
        if not IsValid(ScoreboardDerma) then
            ...
            ScoreboardDerma.Paint = function()
                draw.RoundedBox(0, 0, 0, ScoreboardDerma:GetWide(), ScoreboardDerma:GetTall(), Color(40, 40, 40, 155))
                draw.SimpleText("Homigraded", Board, 325, 4, Color(255, 255, 255))
            end
        ...
        if IsValid(ScoreboardDerma) then
            ...
            for k, v in pairs(player.GetAll()) do
                ...
                local PlayerRang = team.GetName(v:Team())
                PlayerPanel:SetSize(PlayerList:GetWide(), 50)
                PlayerPanel:SetPos(0, 0)
                PlayerPanel.Paint = function()
                    draw.RoundedBox(0, 0, 0, PlayerPanel:GetWide(), PlayerPanel:GetTall(), Color(50, 50, 50, 55))
